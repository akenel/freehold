...
- [Freehold Caddy SOP](freehold-caddy-sop.md) — wolfhold box gotchas: Caddy needs the prod overlay or it crash-loops, refused ≠ banned, no fail2ban; **read before touching the box**
